...
def dit_latents_to_vae_latents(
    ...
    """Unnormalize latents from DiT-output space to gaussian space.
    The DiT outputs samples in a gaussian space.
    The VAE space is not-quite gaussian.

    YOU DO NOT NEED TO CALL THIS ON LATENTS GENERATED BY THE ENCODER.

    Args:
        dit_outputs (torch.Tensor): [B, C_z, T_z, H_z, W_z], float
